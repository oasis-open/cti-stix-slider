...
We're thrilled that you're interested in contributing to the stix2-slider!
...
- All contributors must sign a Contributor License Agreement. See
  `CONTRIBUTING.md <https://github.com/oasis-open/cti-stix-slider/blob/master/CONTRIBUTING.md>`_
...
tested with `Travis-CI <https://travis-ci.org/oasis-open/cti-stix-slider>`_
automatically.
